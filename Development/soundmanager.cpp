    ...
    mHeroInVillage(false)
{
    ...
    playlist_world->addMedia(QUrl("qrc:/audio/Ressources/musics/music_world.wav"));
    ...
    playlist_village->addMedia(QUrl("qrc:/audio/Ressources/musics/music_village_1.wav"));
    playlist_village->addMedia(QUrl("qrc:/audio/Ressources/musics/music_village_2.wav"));
    playlist_village->addMedia(QUrl("qrc:/audio/Ressources/musics/music_village_3.wav"));
    ...
    playlist_fight->addMedia(QUrl("qrc:/audio/Ressources/musics/music_fight_1.wav"));
    ...
    playlist_event->addMedia(QUrl("qrc:/audio/Ressources/musics/music_event_0.wav"));
    playlist_event->addMedia(QUrl("qrc:/audio/Ressources/musics/music_event_1.wav"));
    playlist_event->addMedia(QUrl("qrc:/audio/Ressources/musics/music_event_2.wav"));
    ...
    pickObject->setMedia(QUrl("qrc:/audio/Ressources/sounds/sound_pick.wav"));
    pickObject->setVolume(5);

    drink = new QMediaPlayer(this);
    drink->setMedia(QUrl("qrc:/audio/Ressources/sounds/sound_drink.wav"));
    drink->setVolume(5);

    openChest = new QMediaPlayer(this);
    openChest->setMedia(QUrl("qrc:/audio/Ressources/sounds/sound_openchest.wav"));
    openChest->setVolume(10);

    closeChest = new QMediaPlayer(this);
    closeChest->setMedia(QUrl("qrc:/audio/Ressources/sounds/sound_closechest.wav"));
    closeChest->setVolume(10);

    heroAttack = new QMediaPlayer(this);
    heroAttack->setMedia(QUrl("qrc:/audio/Ressources/sounds/sound_hero_attack_generic.wav"));
    heroAttack->setVolume(20);

    rockMoved = new QMediaPlayer(this);
    rockMoved->setMedia(QUrl("qrc:/audio/Ressources/sounds/sound_move_rock.wav"));
    rockMoved->setVolume(40);

    plankMoved = new QMediaPlayer(this);
    plankMoved->setMedia(QUrl("qrc:/audio/Ressources/sounds/sound_move_plank.wav"));
    ...
    bushShaked_3->setMedia(QUrl("qrc:/audio/Ressources/sounds/sound_bush_shaked_3.wav"));
    bushShaked_3->setVolume(5);

    bushShakedCoins = new QMediaPlayer(this);
    bushShakedCoins->setMedia(QUrl("qrc:/audio/Ressources/sounds/sound_bush_shaked_coins.wav"));
    bushShakedCoins->setVolume(5);

    bushShakedEquipment = new QMediaPlayer(this);
    bushShakedEquipment->setMedia(QUrl("qrc:/audio/Ressources/sounds/sound_bush_shaked_equipment.wav"));
    bushShakedEquipment->setVolume(5);

    beginFight = new QMediaPlayer(this);
    beginFight->setMedia(QUrl("qrc:/audio/Ressources/sounds/sound_start_fight.wav"));
    beginFight->setVolume(50);

    showPannel = new QMediaPlayer(this);
    showPannel->setMedia(QUrl("qrc:/audio/Ressources/sounds/sound_show_pannel.wav"));
    showPannel->setVolume(10);

    treeFall = new QMediaPlayer(this);
    treeFall->setMedia(QUrl("qrc:/audio/Ressources/sounds/sound_tree_fall.wav"));
    treeFall->setVolume(10);

    rockCrush = new QMediaPlayer(this);
    rockCrush->setMedia(QUrl("qrc:/audio/Ressources/sounds/sound_rock_crush.wav"));
    rockCrush->setVolume(10);

    wolfSound = new QMediaPlayer(this);
    wolfSound->setMedia(QUrl("qrc:/audio/Ressources/sounds/sound_wolf.wav"));
    wolfSound->setVolume(5);

    wolfAggroSound = new QMediaPlayer(this);
    wolfAggroSound->setMedia(QUrl("qrc:/audio/Ressources/sounds/sound_wolf_aggro.wav"));
    wolfAggroSound->setVolume(5);

    wolfHeavyAttack = new QMediaPlayer(this);
    wolfHeavyAttack->setMedia(QUrl("qrc:/audio/Ressources/sounds/sound_wolf_heavy_attack.wav"));
    wolfHeavyAttack->setVolume(5);

    wolfLightAttack = new QMediaPlayer(this);
    wolfLightAttack->setMedia(QUrl("qrc:/audio/Ressources/sounds/sound_wolf_light_attack.wav"));
    wolfLightAttack->setVolume(15);

    wolfRoar = new QMediaPlayer(this);
    wolfRoar->setMedia(QUrl("qrc:/audio/Ressources/sounds/sound_wolf_aggro.wav"));
    wolfRoar->setVolume(5);

    wolfDie = new QMediaPlayer(this);
    wolfDie->setMedia(QUrl("qrc:/audio/Ressources/sounds/sound_wolf_die.wav"));
    wolfDie->setVolume(5);

    bearSound = new QMediaPlayer(this);
    bearSound->setMedia(QUrl("qrc:/audio/Ressources/sounds/sound_bear.wav"));
    bearSound->setVolume(5);

    bearAggroSound = new QMediaPlayer(this);
    bearAggroSound->setMedia(QUrl("qrc:/audio/Ressources/sounds/sound_bear_aggro.wav"));
    bearAggroSound->setVolume(5);

    bearHeavyAttack = new QMediaPlayer(this);
    bearHeavyAttack->setMedia(QUrl("qrc:/audio/Ressources/sounds/sound_bear_heavy_attack.wav"));
    bearHeavyAttack->setVolume(10);

    bearLightAttack = new QMediaPlayer(this);
    bearLightAttack->setMedia(QUrl("qrc:/audio/Ressources/sounds/sound_bear_light_attack.wav"));
    bearLightAttack->setVolume(15);

    bearRoar = new QMediaPlayer(this);
    bearRoar->setMedia(QUrl("qrc:/audio/Ressources/sounds/sound_bear.wav"));
    bearRoar->setVolume(10);

    bearDie = new QMediaPlayer(this);
    bearDie->setMedia(QUrl("qrc:/audio/Ressources/sounds/sound_bear_die.wav"));
    bearDie->setVolume(5);

    goblinSound = new QMediaPlayer(this);
    goblinSound->setMedia(QUrl("qrc:/audio/Ressources/sounds/sound_goblin.wav"));
    goblinSound->setVolume(5);

    goblinAggroSound = new QMediaPlayer(this);
    goblinAggroSound->setMedia(QUrl("qrc:/audio/Ressources/sounds/sound_goblin_aggro.wav"));
    goblinAggroSound->setVolume(5);

    goblinHeavyAttack = new QMediaPlayer(this);
    goblinHeavyAttack->setMedia(QUrl("qrc:/audio/Ressources/sounds/sound_goblin_heavy_attack.wav"));
    goblinHeavyAttack->setVolume(10);

    goblinLightAttack = new QMediaPlayer(this);
    goblinLightAttack->setMedia(QUrl("qrc:/audio/Ressources/sounds/sound_goblin_light_attack.wav"));
    goblinLightAttack->setVolume(50);

    goblinRoar = new QMediaPlayer(this);
    goblinRoar->setMedia(QUrl("qrc:/audio/Ressources/sounds/sound_goblin_aggro.wav"));
    goblinRoar->setVolume(5);

    goblinDie = new QMediaPlayer(this);
    goblinDie->setMedia(QUrl("qrc:/audio/Ressources/sounds/sound_goblin_die.wav"));
    goblinDie->setVolume(5);

    trollSound = new QMediaPlayer(this);
    trollSound->setMedia(QUrl("qrc:/audio/Ressources/sounds/sound_troll.wav"));
    trollSound->setVolume(5);

    trollAggroSound = new QMediaPlayer(this);
    trollAggroSound->setMedia(QUrl("qrc:/audio/Ressources/sounds/sound_troll_aggro.wav"));
    trollAggroSound->setVolume(5);

    trollHeavyAttack = new QMediaPlayer(this);
    trollHeavyAttack->setMedia(QUrl("qrc:/audio/Ressources/sounds/sound_troll_heavy_attack.wav"));
    trollHeavyAttack->setVolume(10);

    trollLightAttack = new QMediaPlayer(this);
    trollLightAttack->setMedia(QUrl("qrc:/audio/Ressources/sounds/sound_troll_light_attack.wav"));
    trollLightAttack->setVolume(10);

    trollRoar = new QMediaPlayer(this);
    trollRoar->setMedia(QUrl("qrc:/audio/Ressources/sounds/sound_troll_aggro.wav"));
    trollRoar->setVolume(5);

    trollDie = new QMediaPlayer(this);
    trollDie->setMedia(QUrl("qrc:/audio/Ressources/sounds/sound_trolln_die.wav"));
    trollDie->setVolume(5);

    oggreSound = new QMediaPlayer(this);
    oggreSound->setMedia(QUrl("qrc:/audio/Ressources/sounds/sound_oggre.wav"));
    oggreSound->setVolume(5);

    oggreAggroSound = new QMediaPlayer(this);
    oggreAggroSound->setMedia(QUrl("qrc:/audio/Ressources/sounds/sound_oggre_aggro.wav"));
    oggreAggroSound->setVolume(5);

    oggreHeavyAttack = new QMediaPlayer(this);
    oggreHeavyAttack->setMedia(QUrl("qrc:/audio/Ressources/sounds/sound_oggre_heavy_attack.wav"));
    oggreHeavyAttack->setVolume(15);

    oggreLightAttack = new QMediaPlayer(this);
    oggreLightAttack->setMedia(QUrl("qrc:/audio/Ressources/sounds/sound_oggre_light_attack.wav"));
    oggreLightAttack->setVolume(5);

    oggreRoar = new QMediaPlayer(this);
    oggreRoar->setMedia(QUrl("qrc:/audio/Ressources/sounds/sound_oggre_aggro.wav"));
    oggreRoar->setVolume(5);

    oggreDie = new QMediaPlayer(this);
    oggreDie->setMedia(QUrl("qrc:/audio/Ressources/sounds/sound_oggre_die.wav"));
    oggreDie->setVolume(5);

    equipmentSet = new QMediaPlayer(this);
    equipmentSet->setMedia(QUrl("qrc:/audio/Ressources/sounds/sound_equip.wav"));
    equipmentSet->setVolume(5);

    stuffSold = new QMediaPlayer(this);
    stuffSold->setMedia(QUrl("qrc:/audio/Ressources/sounds/sound_buy.wav"));
    stuffSold->setVolume(10);

    forge = new QMediaPlayer(this);
    forge->setMedia(QUrl("qrc:/audio/Ressources/sounds/sound_forge.wav"));
    forge->setVolume(10);

    laoshanlungSound = new QMediaPlayer(this);
    laoshanlungSound->setMedia(QUrl("qrc:/audio/Ressources/sounds/sound_laoshanlung.wav"));
    laoshanlungSound->setVolume(5);

    laoshanlungAggroSound = new QMediaPlayer(this);
    laoshanlungAggroSound->setMedia(QUrl("qrc:/audio/Ressources/sounds/sound_laoshanlung_aggro.wav"));
    laoshanlungAggroSound->setVolume(5);

    laoshanlungHeavyAttack = new QMediaPlayer(this);
    laoshanlungHeavyAttack->setMedia(QUrl("qrc:/audio/Ressources/sounds/sound_laoshanlung_heavy_attack.wav"));
    laoshanlungHeavyAttack->setVolume(10);

    laoshanlungLightAttack = new QMediaPlayer(this);
    laoshanlungLightAttack->setMedia(QUrl("qrc:/audio/Ressources/sounds/sound_laoshanlung_light_attack.wav"));
    laoshanlungLightAttack->setVolume(10);

    laoshanlungRoar = new QMediaPlayer(this);
    laoshanlungRoar->setMedia(QUrl("qrc:/audio/Ressources/sounds/sound_laoshanlung.wav"));
    laoshanlungRoar->setVolume(5);

    laoshanlungDie = new QMediaPlayer(this);
    laoshanlungDie->setMedia(QUrl("qrc:/audio/Ressources/sounds/sound_laoshanlung_die.wav"));
    ...
    teleport->setMedia(QUrl("qrc:/audio/Ressources/sounds/sound_teleport.wav"));
    teleport->setVolume(25);

    spiderSound = new QMediaPlayer(this);
    spiderSound->setMedia(QUrl("qrc:/audio/Ressources/sounds/sound_spider.wav"));
    spiderSound->setVolume(15);

    spiderAggroSound = new QMediaPlayer(this);
    spiderAggroSound->setMedia(QUrl("qrc:/audio/Ressources/sounds/sound_spider_aggro.wav"));
    spiderAggroSound->setVolume(5);

    spiderHeavyAttack = new QMediaPlayer(this);
    spiderHeavyAttack->setMedia(QUrl("qrc:/audio/Ressources/sounds/sound_spider_heavy_attack.wav"));
    spiderHeavyAttack->setVolume(15);

    spiderLightAttack = new QMediaPlayer(this);
    spiderLightAttack->setMedia(QUrl("qrc:/audio/Ressources/sounds/sound_spider_light_attack.wav"));
    spiderLightAttack->setVolume(15);

    spiderRoar = new QMediaPlayer(this);
    spiderRoar->setMedia(QUrl("qrc:/audio/Ressources/sounds/sound_spider_aggro.wav"));
    spiderRoar->setVolume(10);

    spiderDie = new QMediaPlayer(this);
    spiderDie->setMedia(QUrl("qrc:/audio/Ressources/sounds/sound_spider_aggro.wav"));
...
void SoundManager::playSound(int sound)
{
    ...
    case SOUND_SPELL_6:
    case SOUND_SPELL_7:
        spell->setMedia(QUrl(QString("qrc:/audio/Ressources/sounds/sound_spell_%1.wav").arg(sound-SOUND_SPELL_0)));
        spell->play();
        break;
...
void SoundManager::setHeroAttack(Weapon * weapon)
{
    ...
    if(bow)
    {
        heroAttack->setMedia(QUrl("qrc:/audio/Ressources/sounds/sound_hero_attack_bow.wav"));
    }
    else
    {
        heroAttack->setMedia(QUrl("qrc:/audio/Ressources/sounds/sound_hero_attack_generic.wav"));

...
Consumable::Consumable(QString name, QString imagePath, int weight, int price, int capacity):
...
{
    return Feature{getCapacity(),QString(":/icons/Ressources/potion_logo.png")};
}
...
PotionLife::PotionLife():
    Consumable ("Potion de vie", QString(":/consumables/Ressources/potionLife.png"), 5, 5, 100)
{
...
PotionMana::PotionMana():
    Consumable ("Potion de mana", QString(":/consumables/Ressources/potionMana.png"), 5, 6, 100)
{
...
PotionStamina::PotionStamina():
    Consumable ("Potion de vitalité", QString(":/consumables/Ressources/potionStamina.png"), 4, 7, 5)
{
...
PotionStrenght::PotionStrenght():
    Consumable ("Potion de force", QString(":/consumables/Ressources/potionStrenght.png"), 5, 8, 5)
{
...
PotionKnowledge::PotionKnowledge():
    Consumable ("Potion ancienne", QString(":/consumables/Ressources/potionKnowledge.png"), 5, 8, 1)
{
...
Fish::Fish(QString name, QString imagePath, int weight, int price, int capacity):
    Consumable (name, imagePath, weight, price, capacity)
{
...
RedFish::RedFish():
    Fish("Poisson rouge", QString(":/consumables/Ressources/fish_red.png"), 4, 4, 40)
{
...
BlueFish::BlueFish():
    Fish("Poisson bleu", QString(":/consumables/Ressources/fish_blue.png"), 4, 5, 30)
{
...
Yellowfish::Yellowfish():
    Fish("Poisson jaune", QString(":/consumables/Ressources/fish_yellow.png"), 4, 15, 10)
{
...
CommonFish::CommonFish():
    Fish("Poisson commun", QString(":/consumables/Ressources/fish_common.png"), 4, 3, 10)
{

...
ItemGenerator::ItemGenerator()
{
    mSwords << new Sword("Épée rouillée\nbrisée", QPixmap(":/equipment/sword_0.png"), DMG(2), 5, 10, 1, "Épée rouillée et cassée, globalement en très mavais état.", ABLE(HeroAbleToUSe::eSwordman)|ABLE(HeroAbleToUSe::eWizard))
            ...
            << new Sword("Katana maléfique", QPixmap(":/equipment/sword_5.png"), DMG(100), 8, 40, 62, "Arme mystérieuse de très bonne qualité, la lame semble irigée de sang ce qui lui confère une aura maléfique des plus pesante.")
            ...
            << new Sword("Dague de ninja", QPixmap(":/equipment/sword_10.png"), DMG(55), 9, 10, 37, "Dague de bonne qualité, La lame bleu de cette dague est d'un bleu à faire plalir le ciel lui-même.", ABLE(HeroAbleToUSe::eSwordman)|ABLE(HeroAbleToUSe::eArcher))
            ...
            << new Sword("Épée de boucher", QPixmap(":/equipment/sword_12.png"), DMG(85), 2, 25, 16, "Épée de boucher qui saura aussi bien couper la viande que vos enemis.")
    ...
    mBows   << new Bow("Arc en bois", QPixmap(":/equipment/bow_0.png"), DMG(2), 5, 5, 1, "Arc réalisé avec une branche de bois.", ABLE(HeroAbleToUSe::eArcher)|ABLE(HeroAbleToUSe::eSwordman))
            ...
            << new Bow("Arc du vent", QPixmap(":/equipment/bow_12.png"), DMG(50), 9, 10, 25, "Arc très maniable dont-il émane une certaine puissance céleste.")
            ...
            << new Bow("Arc de glace", QPixmap(":/equipment/bow_15.png"), DMG(90), 7, 10, 52, "Arc ancien de provenance inconnue, une aura glaciale s'émane de cette arme.");

    mStaffs << new Staff("branche", QPixmap(":/equipment/staff_0.png"), DMG(2), 6, 10, 1, "Simple branche de bois.", ABLE(HeroAbleToUSe::eWizard)|ABLE(HeroAbleToUSe::eSwordman))
            << new Staff("Bâton en chêne", QPixmap(":/equipment/staff_1.png"), DMG(4), 6, 10, 1, "Baton taillé dans une branche de chêne.", ABLE(HeroAbleToUSe::eWizard)|ABLE(HeroAbleToUSe::eSwordman))
            << new Staff("Bâton scrulpté", QPixmap(":/equipment/staff_2.png"), DMG(10), 6, 10, 4, "Bâton rudimentaire taillé par un artisant.")
            << new Staff("Bâton scrulpté", QPixmap(":/equipment/staff_3.png"), DMG(10), 6, 10, 4, "Bâton rudimentaire taillé par un artisant.")
            << new Staff("Bâton d'apprenti\nmage", QPixmap(":/equipment/staff_4.png"), DMG(22), 6, 10, 7, "Bâton de bonne confection idéale pour un mage apprenti.")
            << new Staff("Bâton de druide", QPixmap(":/equipment/staff_5.png"), DMG(26), 5, 10, 12, "Bâton de druide aux propriétés de la terre, ornementé d'une pierre inconnue blanche.")
            << new Staff("Bâton de druide", QPixmap(":/equipment/staff_6.png"), DMG(24), 6, 10, 11, "Bâton de druide aux propriétés de la terre, ornementé d'une pierre inconnue verte.")
            << new Staff("Bâton de druide", QPixmap(":/equipment/staff_7.png"), DMG(22), 6, 10, 10, "Bâton de druide aux propriétés de la terre")
            << new Staff("Bâton de mage", QPixmap(":/equipment/staff_8.png"), DMG(35), 5, 10, 1, "Bâton de mage aux propriétés de la terre, ornementé d'une pierre inconnue verte.")
            << new Staff("Sceptre ornementé", QPixmap(":/equipment/staff_9.png"), DMG(25), 5, 10, 40, "Sceptre magnifique provenant d'une noble famille.")
            << new Staff("Sceptre noir", QPixmap(":/equipment/staff_10.png"), DMG(70), 3, 10, 24, "Bâton de mage aux propriétés de l'obscur, son aura est ténébreuse")
            << new Staff("Bâton de lumière", QPixmap(":/equipment/staff_11.png"), DMG(60), 8, 10, 28, "Bâton de mage aux propriétés de la lumière, ornementé d'une magnifique pierre translucide")
            << new Staff("Bâton de l'enfer", QPixmap(":/equipment/staff_12.png"), DMG(72), 6, 10, 32, "Bâton de mage aux propriété de feu possédant une puissance démoniaque.")
            << new Staff("Bâton de\nnécromancien", QPixmap(":/equipment/staff_13.png"), DMG(82), 7, 10, 40, "Bâton de mage aux propriétés de l'obscur possédant une puissance certaine.");

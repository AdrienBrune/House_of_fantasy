...
protected:
    ...
    PassiveSkill* mSkillList[PassiveSkill::NbSkills] = {
        ...
        new PassiveSkill( PassiveSkill::GodBenediction, ABLE(eSwordman)|ABLE(eArcher), "Bénédiction de Dieux", 10, "Accorde un soin constant pendant les combats", false, QPixmap(":/icons/skill/Ressources/skill20.png"), QPixmap(":/icons/skill/Ressources/skill21.png")),
